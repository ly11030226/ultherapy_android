 ...
 * 手柄型号
 */
public class ConfigurationDataDefault800W extends ConfigurationDataBean implements ConfigurationDataClassify {


    public ConfigurationDataDefault800W() {
        ...
        returnDataBean = new ReturnDataBean(1, 10, 1, 31);
    }
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_9() {
        ...
        list.addAll(getCommon(50, 10, 15));
        list.addAll(getCommon(45, 16, 30));
        return list;
    }
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_8() {
        ...
        list.addAll(getCommon_1());
        list.addAll(getCommon(50, 10, 15));
        list.addAll(getCommon(45, 16, 35));
        return list;
    }
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_7() {
        ...
        list.addAll(getCommon_1());
        list.addAll(getCommon(50, 10, 15));
        list.addAll(getCommon(45, 16, 40));
        return list;
    }
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_6() {
        ...
        list.addAll(getCommon_1());
        list.addAll(getCommon(50, 10, 15));
        list.addAll(getCommon(45, 16, 50));
        return list;
    }
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_5() {
        ...
        list.addAll(getCommon_1());
        list.addAll(getCommon(50, 10, 15));
        list.addAll(getCommon(45, 16, 60));
        return list;
    }
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_4() {
        ...
        list.addAll(getCommon_1());
        list.addAll(getCommon(50, 10, 15));
        list.addAll(getCommon(45, 16, 70));
        return list;
    }
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_3() {
        ...
        list.addAll(getCommon_1());
        list.addAll(getCommon(50, 10, 15));
        list.addAll(getCommon(45, 16, 95));
        list.addAll(getCommon(42, 96, 100));
        return list;
    }
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_2() {
        ...
        list.addAll(getCommon_1());
        list.addAll(getCommon(50, 10, 15));
        list.addAll(getCommon(45, 16, 100));
        list.addAll(getCommon(42, 101, 150));
        return list;
    }
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_1() {
        ...
        list.addAll(getCommon_1());
        list.addAll(getCommon(50, 10, 15));
        list.addAll(getCommon(45, 16, 150));
        list.addAll(getCommon(42, 151, 200));
        return list;
    }
    ...
    private int getEnergy_10_above(int coefficient, int ms) {
        int energy = Math.round(coefficient * 16 * 0.80f * ms / 1000);
        return energy;
    }
    ...
    private int getWorkCurrentPercentWithin_10(int energy) {
        // ((能量 / (条数bar * 脉宽 * 工作电压) + 阈值电流) * 换算成百分比 / 最大工作电流)
        int work = (int) Math.round(((energy / (16 * 0.01 * 1.9) + 12) * 100 / 50));
        if (work > 100) {
            work = 100;
        }
        return work;
    ...
    public ConfigurationDataBean getThisBean() {
        CommonUtil.logd("ConfigurationDataDefault800W" , this );
        return this;
    }
