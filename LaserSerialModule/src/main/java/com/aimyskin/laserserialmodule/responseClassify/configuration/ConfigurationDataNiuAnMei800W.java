 ...
 * 手柄型号
 */
public class ConfigurationDataNiuAnMei800W extends ConfigurationDataBean implements ConfigurationDataClassify {

    public ConfigurationDataNiuAnMei800W() {
    ...
    private List<ConfigurationData> getConfigurationData() {
        ...
        List<ConfigurationData.ConfigurationBean> listPulse4 = getBeanList_3();
        ...
        List<ConfigurationData.ConfigurationBean> listPulse9 = getBeanList_8();
        ...
        List<ConfigurationData.ConfigurationBean> listPulse10 = getBeanList_8();
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_5() {
        List<ConfigurationData.ConfigurationBean> list = new ArrayList<>();
        list.addAll(getCommon_1());
        list.addAll(getCommon(98, 10, 60));
        return list;
    }
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_3() {
        List<ConfigurationData.ConfigurationBean> list = new ArrayList<>();
        list.addAll(getCommon_1());
        list.addAll(getCommon(98, 10, 70));
        return list;
    }
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_2() {
        List<ConfigurationData.ConfigurationBean> list = new ArrayList<>();
        list.addAll(getCommon_1());
        list.addAll(getCommon(98, 10, 80));
        return list;
    }
    ...
    private List<ConfigurationData.ConfigurationBean> getBeanList_1() {
        List<ConfigurationData.ConfigurationBean> list = new ArrayList<>();
        list.addAll(getCommon_1());
        list.addAll(getCommon(98, 10, 100));
        list.addAll(getCommon(88, 101, 200));
        return list;
    }
    ...
    private int getWorkCurrentPercent_10_Within(int e) {
        ...
        int work = (int) Math.round(((e / (8 * 0.01 * 1.24 * 0.95) + 18) * 100 / 98));
        if (work > 100) {
            work = 100;
        }
        return work;
    ...
    private int getEnergy_10_above(int coefficient, int ms) {
        // J=(工作电流98-阈值电流18)*斜效率1.24 * 能量降低系数 *bar条数8*(脉宽/1000)
        int energy = (int) Math.round((coefficient - 18) * 1.24 * 0.95 * 8 * ms / 1000);
        return energy;
    }
